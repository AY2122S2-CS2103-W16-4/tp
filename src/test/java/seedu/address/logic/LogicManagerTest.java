...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonRealEstateProStorage addressBookStorage =
                new JsonRealEstateProStorage(temporaryFolder.resolve("addressBook.json"));
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        JsonRealEstateProStorage addressBookStorage =
                new JsonRealEstateProIoExceptionThrowingStub(temporaryFolder.resolve("ioExceptionAddressBook.json"));
     ...
     */
    private static class JsonRealEstateProIoExceptionThrowingStub extends JsonRealEstateProStorage {
        private JsonRealEstateProIoExceptionThrowingStub(Path filePath) {
            super(filePath);
        }
